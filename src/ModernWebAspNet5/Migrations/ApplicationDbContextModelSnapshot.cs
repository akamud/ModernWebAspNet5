...
using ModernWebAspNet5.Models;

namespace ModernWebAspNet5.Migrations
{
    [ContextType(typeof(ModernWebAspNet5.Models.ApplicationDbContext))]
    public class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override IModel Model
        {
            get
            {
                ...
                builder.Entity("ModernWebAspNet5.Models.ApplicationUser", b =>
                {
                ...
                builder.Entity("Microsoft.AspNet.Identity.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]", b =>
                {
                    b.ForeignKey("ModernWebAspNet5.Models.ApplicationUser", "UserId");
                });
